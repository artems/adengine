	...
	for (var i in __tban) {
		...
		switch (el.type){
			case 0:	
					...
					kstr += '<div style="width: 234px !important; height: 129px; border: 1px solid #b8b8b8; display: block; margin: 2px 2px 2px 2px; border-radius:3px; -webkit-border-radius:3px; -moz-border-radius:3px; -khtml-border-radius: 3px;">\n';
					kstr += '<div style="float: left; width : 100px; height: 120px; margin: 4px;">\n';
					kstr += '<a href="'+el.banner_url+'" target="_blank" style="text-decoration:none;">\n';
					kstr += '<img width=100 height=120 border=0 src="'+el.picture+'"></div>\n';
					kstr += '</a>\n';
					kstr += '<div style="float: right; width: 112px; height: 120px; margin: 4px 8px 8px 4px; font-size:12px!important; line-height:16px!important; font-family: Arial ! important; color:#116cb2!important;">\n';
					kstr += '<a href="'+el.banner_url+'" target="_blank" style="text-decoration:none;">\n';
					...
					if (price) kstr += '<div style="float: bottom; width: 100%; margin: 6px 0 0 0; color: #ed801f; font-size: 18px !important; line-height: 20px !important; font-weight: bold; text-decoration:none;">'+el.price+'</div>\n';
					kstr += '</a>\n';
					kstr += '</div>\n';
					kstr += '</div>\n';
					break;
